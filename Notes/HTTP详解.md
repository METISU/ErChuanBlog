...
但是这样还有个问题，遇到中间人攻击，如果中介人截获了传输秘钥，因为服务端的公钥是开放的，所有人都可以拿到，因此黑客截获了密文之后，即便无法解密，但是可以把自己的对称秘钥使用服务端的公钥加密，然后传输给服务端，服务端解密后，再经过黑客，黑客便能获得信息，然后可以伪造客户端和服务端进行通讯。或者黑客干脆伪造身份，假装是服务端，给你他的公钥，客户端拿到公钥无法确认是谁的公钥，这样客户端就会和黑客建立连接，进行通讯。
