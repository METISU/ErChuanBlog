...
``` Objective-C
- (void)argumentOne:(int)one two:(int)two three:(int)three four:(int)four five:(int)five six:(int)six {
    NSLog(@"%@", [NSString stringWithFormat:@"one:%d\n tow:%d\n three:%d\n four:%d\n five:%d\n six:%d\n", one, two, three, four, five, six]);
}
```
断点之后在lldb打印

![image](https://user-images.githubusercontent.com/22512175/121311836-5ddbc400-c937-11eb-85c7-98814259f0dc.png)
...
![image](https://user-images.githubusercontent.com/22512175/121312800-51a43680-c938-11eb-87f7-a6237c29d2a4.png)
